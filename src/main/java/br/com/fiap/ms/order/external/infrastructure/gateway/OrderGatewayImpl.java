...
import br.com.fiap.ms.order.adapter.gateways.OrderGatewayInterface;
...
import br.com.fiap.ms.order.domain.exception.BaseException;
...
import br.com.fiap.ms.order.domain.exception.order.InvalidProductStorageException;
import br.com.fiap.ms.order.domain.exception.order.OrderNotFoundException;
import br.com.fiap.ms.order.domain.model.Order;
import br.com.fiap.ms.order.domain.utils.NumberOrderGenerator;
import br.com.fiap.ms.order.external.infrastructure.entities.*;
import br.com.fiap.ms.order.external.infrastructure.repositories.NotificationRepository;
...
import br.com.fiap.ms.order.external.infrastructure.webhook.Payments;
    ...
    public OrderResultFormDto register(OrderFormDto orderFormDto, ClientDB client) throws InvalidProcessException {
        ...
        for (ProductDB prod : products) {
            ...
            if (prod.hasStorage()) {
                ...
                //TODO acionar microservico de produto para salvar
